...
export function Admin({ username }: { username: string }) {
  ...
  function navigate(next: Section) { setSection(next); setSearch(''); setStatus('all'); setPage(1); setNotice(''); setDeleting(null); }
